 ...
 */
+ (void)setDelegate:(id<AFAdUnitDelegate>)delegate;
...
/*!
 *  @brief Get the current Ad Unit version.
 *
 *  @return The current version of Ad Unit.
 */
+ (NSString *)getAdUnitVersion;
